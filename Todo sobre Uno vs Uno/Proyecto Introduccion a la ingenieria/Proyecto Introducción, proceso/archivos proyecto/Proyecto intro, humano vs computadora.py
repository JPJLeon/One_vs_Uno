...
################################################# Turno Computadora ########################################################################
                        ...
                        while True:
                                ...
                                if jugada1=="B":
                                        ...
                                        #for color_mano,tipo_mano in cartas_en_mano:
                                        #       if tuple((color_mano,tipo_mano))in diccionario_de_opciones:
                                        #               if diccionario_de_opciones[tuple((color_mano,tipo_mano))]>=mejor_puntuacion:
                                        #                       mejor_carta=tuple((color_mano,tipo_mano))
                                        #                       mejor_puntuacion=diccionario_de_opciones[tuple((color_mano,tipo_mano))]
