...
def obtener_puntuacion_bot(lista,manofinal,ct1,ctb,cr1,crb,lista_trampa):
        ...
        if crb==0:
                crb=1
        a=((tamano_lista+tamano_lista_trampa)*cr1)/(crb)-len(manofinal)*crb
        return a
...
def obtener_puntuacion_jug(lista,manofinal,ct1,ctb,cr1,crb,lista_trampa):
        ...
        if crb==0:
                crb=1
        a=((tamano_lista+tamano_lista_trampa)*crb)/(cr1)-len(manofinal)*cr1
        return a
...
################################################# Turno Computadora 2 ########################################################################
                        ...
                        while True:
                                ...
                                if mejor_carta==0:
                                        ...
                                        jugadia=comprobar_jug(mejor_carta)
                                        if jugadia[0]==True:
                                                print "UnoBotDos ha jugado la carta",mejor_carta
